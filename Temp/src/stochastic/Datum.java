...
public class Datum {
	...
	public void setLabel(Datum aDatum) {
		...
		if (!ruleApplied) {
			if ((this.Label != aDatum.Label)
					&& ((this.Label > -1) && (aDatum.Label > -1))) {
				this.decreaseM();
				aDatum.decreaseM();
				// if (this.M < aDatum.M) {
				this.setLabel(aDatum.Label);
	...
	public boolean acceptance(Datum item_j) {
		...
		if (sim_ij > higherTemplate) {
			// System.out.println(" ACCEPT symbol 1:" + this.symbol + " and " +
			// item_j.symbol + " sim = " + sim_ij + ", higherTemplate = " +
			// higherTemplate);
			accept = true;
		} else {
			// System.out.println(" REJECT symbol 1:" + this.symbol + " and " +
			// item_j.symbol + " sim = " + sim_ij + ", higherTemplate = " +
			// higherTemplate);
		...
		for (int i = 0; i < allItems.length; i++) {
			...
			for (int j = 0; j < nearestItems.size(); j++) {
				...
				if (!nearestItems.contains(anItem)) {
					if (this.distanceFrom(anotherItem) > this
							.distanceFrom(anItem)) {
						itemToAdd = anItem;
	...
	public Datum(String dataDetails, double d1, char c1) // written for GENERAL
															// FILE data
	{
		...
		if ((Parameters.dataSetName.compareTo("http") == 0)
				...
				|| (Parameters.dataSetName
						.compareTo("Mulcross_1percent_missing") == 0)
				|| (Parameters.dataSetName
						.compareTo("Mulcross_10percent_missing") == 0)
				|| (Parameters.dataSetName
						.compareTo("Mulcross_20percent_missing") == 0)
				|| (Parameters.dataSetName
						.compareTo("Mulcross_30percent_missing") == 0)
				|| (Parameters.dataSetName
						.compareTo("Mulcross_40percent_missing") == 0)
				|| (Parameters.dataSetName.compareTo("Mulcross_32768") == 0)) {
			if (classLabel.compareTo("0") == 0)
				symbol = '/';
		}
		if (classLabel.compareTo("1") == 0)
			symbol = '+';
		if (classLabel.compareTo("2") == 0)
			symbol = 'x';
		if (classLabel.compareTo("3") == 0)
			symbol = 'o';
		if (classLabel.compareTo("4") == 0)
			symbol = '*';
		if (classLabel.compareTo("5") == 0)
			symbol = '-';
		if (classLabel.compareTo("6") == 0)
			symbol = ':';
		if (classLabel.compareTo("7") == 0)
			symbol = '#';
		if (classLabel.compareTo("8") == 0)
			symbol = '=';
		if (classLabel.compareTo("9") == 0)
			symbol = '%';
		if (classLabel.compareTo("10") == 0)
			symbol = '$';
		if (classLabel.compareTo("11") == 0)
			symbol = 'a';
		if (classLabel.compareTo("12") == 0)
			symbol = 'b';
		if (classLabel.compareTo("13") == 0)
			symbol = 'c';
		if (classLabel.compareTo("14") == 0)
			symbol = 'd';
		if (classLabel.compareTo("15") == 0)
			symbol = 'e';
		if (classLabel.compareTo("16") == 0)
			symbol = 'f';
		if (classLabel.compareTo("17") == 0)
			symbol = 'g';
		if (classLabel.compareTo("18") == 0)
			symbol = 'h';
		if (classLabel.compareTo("19") == 0)
			symbol = 'i';
		if (classLabel.compareTo("20") == 0)
			symbol = 'j';
		if (classLabel.compareTo("21") == 0)
			symbol = 'k';
		if (classLabel.compareTo("22") == 0)
			symbol = 'l';
		if (classLabel.compareTo("23") == 0)
			symbol = 'm';
		if (classLabel.compareTo("24") == 0)
			symbol = 'n';
		if (classLabel.compareTo("25") == 0)
			symbol = 'o';
		if (classLabel.compareTo("26") == 0)
			symbol = 'p';
		if (classLabel.compareTo("27") == 0)
			symbol = 'q';
		if (classLabel.compareTo("28") == 0)
			symbol = 'r';
		if (classLabel.compareTo("29") == 0)
			symbol = 's';
		if (classLabel.compareTo("30") == 0)
			symbol = 't';
		if (classLabel.compareTo("31") == 0)
			symbol = 'u';
		if (classLabel.compareTo("32") == 0)
			symbol = 'v';
		if (classLabel.compareTo("33") == 0)
			symbol = 'w';
		if (classLabel.compareTo("34") == 0)
			symbol = 'y';
		if (classLabel.compareTo("34") == 0)
			symbol = 'z';
		...
		if ((Parameters.dataSetName.compareTo("http") == 0)
				...
				|| (Parameters.dataSetName
						.compareTo("Mulcross_40percent_missing") == 0)
				|| (Parameters.dataSetName.compareTo("Mulcross_32768") == 0)) {
			c = Integer.parseInt(classLabel); // only for http
		} else {
		...
		// System.out.println(tokens.countTokens()+":total");
		...
		for (int i = 0; i < dim; i++) {
			...
			value[i] = Double.parseDouble(temp);
		}
	...
	public Datum(String dataDetails, int Dummy1, int Dummy2) // written for
																// Wisconsin
																// data
	{
		StringTokenizer tokens;
	...
	public Datum(String dataDetails, int Dummy1, int Dummy2, int Dummy3,
			int Dummy4, int Dummy5, int Dummy6, int Dummy7) // written for xCyD
															// data
	{
		StringTokenizer tokens;
		String Delimiters = " ";
		...
		if (Parameters.numClusters == 4) {
			if (classLabel == 0) {
				symbol = '+';
				Parameters.clusterSizes[0]++;
			}
			if (classLabel == 1) {
				symbol = 'x';
				Parameters.clusterSizes[1]++;
			}
			if (classLabel == 2) {
				symbol = 'o';
				Parameters.clusterSizes[2]++;
			}
			if (classLabel == 3) {
				symbol = '*';
				Parameters.clusterSizes[3]++;
			}
		} else {
			if (Parameters.numClusters == 10) {
				...
				if (classLabel == 4) {
					symbol = '-';
					Parameters.clusterSizes[4]++;
				}
				if (classLabel == 5) {
					symbol = ':';
					Parameters.clusterSizes[5]++;
				}
				if (classLabel == 6) {
					symbol = '#';
					Parameters.clusterSizes[6]++;
				}
				if (classLabel == 7) {
					symbol = '=';
					Parameters.clusterSizes[7]++;
				}
				if (classLabel == 8) {
					symbol = '%';
					Parameters.clusterSizes[8]++;
				}
				if (classLabel == 9) {
					symbol = '$';
					Parameters.clusterSizes[9]++;
				}
			} else {
	...
	public double distanceFrom(Datum d) {
		...
		/*
		 * if ((d.getIndex() == -1)||(this.getIndex()==-1)){ dist =
		 * this.distanceFun.precompute(d); return dist/Parameters.maxDist; }
		 * else { dist = this.distanceFun.compute(d); return
		 * dist/Parameters.maxDist; }
		 */
	}
	...
	public double distanceFrom_2DNormal(Datum d) {
		...
		double dist = Parameters.euclidean(dVal[0], dVal[1], this.value[0],
				this.value[1]);
		return dist;
	}
	...
	public String toString() {
		...
		for (int i = 0; i < dim; i++)
			result += fourDigits.format(value[i]) + ", ";
		result += ")";
